...
public class EntityTypeList {
	...
	public static final EntityType<ThreebodyModelEntity> THREEBODY_MODEL = register("threebody_model", EntityType.Builder.<ThreebodyModelEntity>create(ThreebodyModelEntity::new, EntityClassification.MISC).size(2.0F, 2.0F).trackingRange(10).updateInterval(20).immuneToFire().build("threebody_model"));
