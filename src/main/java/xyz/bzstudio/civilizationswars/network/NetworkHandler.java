...
public class NetworkHandler {
	...
	public static final SimpleChannel LIGHT_PARTICLE_FIRE = NetworkRegistry.newSimpleChannel(new ResourceLocation(CivilizationsWars.MODID, "catapult_check"), () -> VERSION, (v) -> v.equals(VERSION), (v) -> v.equals(VERSION));
