...
public class ItemList {
	...
	public static final Item CATAPULT_CONTROLLER = register("catapult_controller", new BlockItem(BlockList.CATAPULT_CONTROLLER, new Item.Properties().group(ItemGroupList.TAB_CIVILIZATIONS_WARS)));
