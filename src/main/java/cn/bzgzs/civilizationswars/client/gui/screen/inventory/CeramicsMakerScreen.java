...
import cn.bzgzs.civilizationswars.inventory.container.SelectSlot;
...
public class CeramicsMakerScreen extends ContainerScreen<CeramicsMakerContainer> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int x, int y) {
		this.font.drawText(matrixStack, new TranslationTextComponent("screen.ceramics_maker.text"), 12, 7, 0xFF7777);
	}
