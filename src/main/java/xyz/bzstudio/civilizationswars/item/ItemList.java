...
public class ItemList {
	...
	public static final Item LIGHT_PARTICLE = register("light_particle", new Item(new Item.Properties().group(ItemGroupList.TAB_CIVILIZATIONS_WARS)));
	...
	public static final Item OBJECT_COMPRESSOR_BLOCK = register("object_compressor_block", new BlockItem(BlockList.OBJECT_COMPRESSOR_BLOCK, new Item.Properties().group(ItemGroupList.TAB_CIVILIZATIONS_WARS)));
